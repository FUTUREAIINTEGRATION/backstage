...
/**
 * Create a Zod schema for validating predicates.
 *
 * @public
 */
export function createPredicateSchema(z: typeof zImpl): ZodType<Predicate> {
  const primitiveSchema = z.union([
    z.string(),
    z.number(),
    z.boolean(),
  ]) as ZodType<PredicatePrimitive>;

  // eslint-disable-next-line prefer-const
  let valuePredicateSchema: ZodType<PredicateValue>;
  ...
  ) as ZodType<PredicateExpression>;
