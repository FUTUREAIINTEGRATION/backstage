...
import { predicateToFilterFunction } from './evaluate';
import { Predicate } from './types';

describe('predicateToFilterFunction', () => {
  const entities = [
    {
  ...
  it.each([
    ...
    ['', { $unknown: 'ignored' } as unknown as Predicate],
    [
      's,w',
    ...
    const filtered = entities.filter(entity =>
      predicateToFilterFunction(filter)(entity),
    );
